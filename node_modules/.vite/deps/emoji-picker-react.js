...
function preloaEmojidIfNeeded(emoji, emojiStyles2, scrollTop, clientHeight, topOffset, style, dimensions, getEmojiUrl) {
  if (!emoji) {
    return;
  }
...
function useEmojiVirtualization(_ref) {
  var categoryEmojis = _ref.categoryEmojis, topOffset = _ref.topOffset, onHeightReady = _ref.onHeightReady, scrollTop = _ref.scrollTop;
  ...
  var emojis2 = emojisToPush.reduce(function(accumulator, emoji, index) {
    ...
    if (dimensions && BodyRef.current && shouldVirtualize({
      ...
      virtualizedCounter++;
      preloaEmojidIfNeeded(emoji, emojiStyle, scrollTop, (_BodyRef$current$clie2 = (_BodyRef$current2 = BodyRef.current) == null ? void 0 : _BodyRef$current2.clientHeight) != null ? _BodyRef$current$clie2 : 0, topOffset, style, dimensions, getEmojiUrl);
      return accumulator;
    }
