...
const UserPolicy = () => {
  ...
  // Scroll to the section matching the URL hash (e.g. /user-policy#legal)
  useEffect(() => {
    if (location.hash) {
      const id = location.hash.replace('#', '');
      // Delay slightly so the page has rendered before we scroll
              ...
              <div className="p-6 md:p-8">
                ...
                <section id="payment" className="mb-12 scroll-mt-4">
                  ...
                  <div className="space-y-6">
                    <div className="border-l-4 border-blue-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-blue-700">1.</span> Platform Services</h3>
                    ...
                    <div className="border-l-4 border-blue-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-blue-700">2.</span> Integration via Stripe Connect</h3>
                      <p className="text-gray-700 mb-3">Users agree that:</p>
                      <ul className="space-y-3 text-gray-700">
                        <li className="flex items-start">
                          <span className="font-semibold text-blue-700 mr-2 min-w-[60px]">2.1</span>
                          <span>FlightElevate shall not be held liable for any disputes arising from the use of the platform.</span>
                        </li>
                        <li className="flex items-start">
                          <span className="font-semibold text-blue-700 mr-2 min-w-[60px]">2.2</span>
                        ...
                        <li className="flex items-start">
                          <span className="font-semibold text-blue-700 mr-2 min-w-[60px]">2.3</span>
                        ...
                        <li className="flex items-start">
                          <span className="font-semibold text-blue-700 mr-2 min-w-[60px]">2.4</span>
                        ...
                        <li className="flex items-start">
                          <span className="font-semibold text-blue-700 mr-2 min-w-[60px]">2.5</span>
                        ...
                        <li className="flex items-start">
                          <span className="font-semibold text-blue-700 mr-2 min-w-[60px]">2.6</span>
                    ...
                    <div className="border-l-4 border-blue-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-blue-700">3.</span> Credit Card & Transaction Fees</h3>
                      <p className="text-gray-700"><strong className="text-blue-700">3.1</strong> Credit card processing fees are determined by Stripe and may fluctuate based on Stripe's pricing or changes to FlightElevate's operational model.</p>
                    </div>
 
                    <div className="border-l-4 border-blue-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-blue-700">4.</span> Card Information Storage and Access</h3>
                ...
                <section id="wallet" className="mb-12 scroll-mt-4">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-gray-900"><span className="text-green-700">5.</span> Digital Wallet & Funds Handling</h2>
                  ...
                  <div className="border-l-4 border-green-200 pl-6">
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex items-start">
                        <span className="font-semibold text-green-700 mr-2 min-w-[36px]">5.1</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-green-700 mr-2 min-w-[36px]">5.2</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-green-700 mr-2 min-w-[36px]">5.3</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-green-700 mr-2 min-w-[36px]">5.4</span>
                ...
                <section id="service" className="mb-12 scroll-mt-4">
                  ...
                  <div className="space-y-6">
                    <div className="border-l-4 border-purple-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-purple-700">6.</span> Introduction</h3>
                      <p className="text-gray-700">
                    ...
                    <div className="border-l-4 border-purple-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-purple-700">7.</span> Subscription Plan</h3>
                      <p className="text-gray-700">
                    ...
                    <div className="border-l-4 border-purple-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-purple-700">8.</span> Customer Responsibilities</h3>
                      <p className="text-gray-700">
                    ...
                    <div className="border-l-4 border-purple-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-purple-700">9.</span> Services Provided</h3>
                ...
                <section id="billing" className="mb-12 scroll-mt-4">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-gray-900"><span className="text-blue-700">11.</span> Billing Authorization</h2>
                  ...
                  <div className="border-l-4 border-blue-200 pl-6">
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex items-start">
                        <span className="font-semibold text-blue-700 mr-2 min-w-[36px]">11.1</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-blue-700 mr-2 min-w-[36px]">11.2</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-blue-700 mr-2 min-w-[36px]">11.3</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-blue-700 mr-2 min-w-[36px]">11.4</span>
                ...
                <section id="support" className="mb-12 scroll-mt-4">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-gray-900"><span className="text-green-700">12.</span> Support</h2>
                  ...
                  <div className="border-l-4 border-green-200 pl-6">
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex items-start">
                        <span className="font-semibold text-green-700 mr-2 min-w-[36px]">12.1</span>
                        <span>FlightElevate currently provides customer support through email communication.</span>
                      </li>
                      <li className="flex items-start">
                        <span className="font-semibold text-green-700 mr-2 min-w-[36px]">12.2</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-green-700 mr-2 min-w-[36px]">12.3</span>
                ...
                <section id="availability" className="mb-12 scroll-mt-4">
                  ...
                  <div className="space-y-6">
                    <div className="border-l-4 border-orange-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-orange-700">13.</span> Platform Use Disclaimer & Service Commitment</h3>
                      <ul className="space-y-3 text-gray-700">
                        <li className="flex items-start">
                          <span className="font-semibold text-orange-700 mr-2 min-w-[36px]">13.1</span>
                        ...
                        <li className="flex items-start">
                          <span className="font-semibold text-orange-700 mr-2 min-w-[36px]">13.2</span>
                    ...
                    <div className="border-l-4 border-orange-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-orange-700">14.</span> Availability & Hosting</h3>
                      <ul className="space-y-3 text-gray-700">
                        <li className="flex items-start">
                          <span className="font-semibold text-orange-700 mr-2 min-w-[36px]">14.1</span>
                        ...
                        <li className="flex items-start">
                          <span className="font-semibold text-orange-700 mr-2 min-w-[36px]">14.2</span>
                        ...
                        <li className="flex items-start">
                          <span className="font-semibold text-orange-700 mr-2 min-w-[36px]">14.3</span>
                        ...
                        <li className="flex items-start">
                          <span className="font-semibold text-orange-700 mr-2 min-w-[36px]">14.4</span>
                        ...
                        <li className="flex items-start">
                          <span className="font-semibold text-orange-700 mr-2 min-w-[36px]">14.5</span>
                        ...
                        <li className="flex items-start">
                          <span className="font-semibold text-orange-700 mr-2 min-w-[36px]">14.6</span>
                ...
                <section id="compliance" className="mb-12 scroll-mt-4">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-gray-900"><span className="text-red-700">15.</span> Data Retention & Regulatory Compliance</h2>
                  ...
                  <div className="border-l-4 border-red-200 pl-6">
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex items-start">
                        <span className="font-semibold text-red-700 mr-2 min-w-[36px]">15.1</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-red-700 mr-2 min-w-[36px]">15.2</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-red-700 mr-2 min-w-[36px]">15.3</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-red-700 mr-2 min-w-[36px]">15.4</span>
                      ...
                      <li className="flex items-start">
                        <span className="font-semibold text-red-700 mr-2 min-w-[36px]">15.5</span>
                ...
                <section id="legal" className="mb-12 scroll-mt-4">
                  ...
                  <div className="space-y-6">
                    <div className="border-l-4 border-indigo-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-indigo-700">16.</span> Limitation of Liability</h3>
                      <p className="text-gray-700 mb-2"><strong className="text-indigo-700">16.1</strong> To the fullest extent permitted by law, FlightElevate shall not be liable for any indirect, incidental, special, consequential, exemplary, or punitive damages arising from or relating to the use of, or inability to use, the Platform.</p>
                      <p className="text-gray-700"><strong className="text-indigo-700">16.2</strong> To the fullest extent permitted by law, FlightElevate's total aggregate liability arising out of or relating to this Agreement shall not exceed the amount paid by the Client to FlightElevate during the 12 months preceding the event giving rise to the claim.</p>
                    </div>
 
                    <div className="border-l-4 border-indigo-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-indigo-700">17.</span> Termination</h3>
                      <p className="text-gray-700 mb-2"><strong className="text-indigo-700">17.1</strong> This Agreement may be terminated by either party with 30 days' written notice.</p>
                      <p className="text-gray-700 mb-2"><strong className="text-indigo-700">17.2</strong> FlightElevate may suspend or terminate access immediately if the Client violates this Agreement, engages in unlawful activity, compromises platform security, or fails to pay applicable fees.</p>
                      <p className="text-gray-700"><strong className="text-indigo-700">17.3</strong> Any fees owed up to the effective termination date shall remain payable and are non-refundable unless otherwise required by law.</p>
                    </div>
 
                    <div className="border-l-4 border-indigo-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-indigo-700">18.</span> Governing Law</h3>
                      <p className="text-gray-700">
                    ...
                    <div className="border-l-4 border-indigo-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-indigo-700">19.</span> Ownership of Data</h3>
                      <ul className="space-y-2 text-gray-700">
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">19.1</span><span>The Client retains ownership of all data, records, documents, and information submitted to or stored within the Platform by the Client and its authorized users ("Client Data").</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">19.2</span><span>The Client grants FlightElevate a limited right to host, store, process, transmit, and display Client Data solely for the purpose of operating, maintaining, securing, supporting, and improving the Platform.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">19.3</span><span>The Client is responsible for ensuring that it has all necessary rights and permissions to upload, store, and process Client Data through the Platform.</span></li>
                      </ul>
                    </div>
 
                    <div className="border-l-4 border-indigo-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-indigo-700">20.</span> Intellectual Property Rights</h3>
                      <ul className="space-y-2 text-gray-700">
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">20.1</span><span>FlightElevate and its licensors retain all rights, title, and interest in and to the Platform, including all software, source code, object code, user interfaces, designs, documentation, trademarks, logos, workflows, features, enhancements, and related intellectual property.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">20.2</span><span>Except for the limited right to access and use the Platform under this Agreement, no ownership rights, licenses, or intellectual property rights are transferred to the Client.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">20.3</span><span>Any suggestions, feedback, recommendations, or enhancement requests provided by the Client may be used by FlightElevate without restriction or obligation.</span></li>
                      </ul>
                    </div>
 
                    <div className="border-l-4 border-indigo-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-center gap-2">
                        <FiLock className="w-4 h-4 text-indigo-700" /> <span className="text-indigo-700">21.</span> Privacy
                      </h3>
                      <ul className="space-y-2 text-gray-700">
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">21.1</span><span>FlightElevate collects, stores, and processes information necessary to provide, maintain, secure, and improve the Platform.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">21.2</span><span>The Client represents and warrants that it has obtained all necessary rights, permissions, and consents required to upload, store, and process information through the Platform.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">21.3</span><span>FlightElevate will implement commercially reasonable administrative, technical, and organizational measures designed to protect Client Data from unauthorized access, use, disclosure, or destruction.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">21.4</span><span>FlightElevate may use aggregated, anonymized, or de-identified data for analytics, service improvement, product development, and business operations, provided such data does not identify the Client or any individual user.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">21.5</span><span>Use of the Platform is also subject to FlightElevate's Privacy Policy, which may be updated from time to time.</span></li>
                      </ul>
                    </div>
 
                    <div className="border-l-4 border-indigo-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-indigo-700">22.</span> Acceptable Use</h3>
                      <p className="text-gray-700 mb-2"><strong className="text-indigo-700">22.1</strong> The Client and its authorized users shall use the Platform only for lawful purposes and in accordance with this Agreement.</p>
                      <p className="text-gray-700 mb-2"><strong className="text-indigo-700">22.2</strong> The Client shall not, and shall not permit any user to:</p>
                      ...
                      <p className="text-gray-700 mt-2"><strong className="text-indigo-700">22.3</strong> FlightElevate may suspend or terminate access to the Platform if it reasonably believes the Client or any user has violated this Section.</p>
                    </div>
 
                    <div className="border-l-4 border-indigo-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-center gap-2">
                        <FiGlobe className="w-4 h-4 text-indigo-700" /> <span className="text-indigo-700">23.</span> Electronic Communications
                      </h3>
                      <ul className="space-y-2 text-gray-700">
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">23.1</span><span>The Client agrees to receive notices, invoices, service updates, account information, and other communications from FlightElevate electronically, including through email, the Platform, or other electronic means.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">23.2</span><span>The Client is responsible for maintaining accurate and current contact information and for monitoring communications sent by FlightElevate.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">23.3</span><span>Electronic communications from FlightElevate shall satisfy any legal requirement that such communications be provided in writing, to the extent permitted by applicable law.</span></li>
                      </ul>
                    </div>
 
                    <div className="border-l-4 border-indigo-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3"><span className="text-indigo-700">24.</span> Entire Agreement</h3>
                      <ul className="space-y-2 text-gray-700">
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">24.1</span><span>This Agreement constitutes the entire agreement between the parties regarding the Platform and supersedes all prior or contemporaneous discussions, proposals, representations, understandings, and agreements relating to its subject matter.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">24.2</span><span>No waiver, modification, or amendment of this Agreement shall be effective unless made in writing by FlightElevate or otherwise permitted through the Platform.</span></li>
                        <li className="flex items-start"><span className="font-semibold text-indigo-700 mr-2">24.3</span><span>If any provision of this Agreement is found to be invalid or unenforceable, the remaining provisions shall remain in full force and effect.</span></li>
                      </ul>
                    </div>
                  </div>
                </section>
