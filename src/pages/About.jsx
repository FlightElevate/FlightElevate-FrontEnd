...
const styles = `
  ...
  .about-runway-grid {
    position: absolute;
    inset: 0;
    background-image: linear-gradient(rgba(143,168,200,0.07) 1px, transparent 1px), linear-gradient(90deg, rgba(143,168,200,0.07) 1px, transparent 1px);
  ...
  .about-hero h1 em { font-style: italic; color: #C8D9EC; }
  .about-hero-sub {
    font-size: 17px;
    font-weight: 400;
    color: #C8D9EC;
  ...
  .about-num { font-family: 'Georgia', serif; font-size: 40px; line-height: 1; color: #ffffff; }
  .about-label { font-size: 12px; font-weight: 500; letter-spacing: 0.1em; text-transform: uppercase; color: #C8D9EC; margin-top: 6px; }
  .about-mission-divider { width: 1px; height: 48px; background: rgba(255,255,255,0.2); }
  .about-container { max-width: 1100px; margin: 0 auto; padding: 0 40px; }
  .about-built-section { padding: 100px 0 80px; }
  .about-built-single { max-width: 720px; }
  .about-section-label { font-size: 11px; font-weight: 600; letter-spacing: 0.14em; text-transform: uppercase; color: #1B4F9B; margin-bottom: 20px; }
  .about-section-title { font-family: 'Georgia', serif; font-size: clamp(30px, 4vw, 46px); font-weight: 400; color: #000000; line-height: 1.18; margin-bottom: 28px; max-width: 520px; }
  .about-section-body { font-size: 16px; font-weight: 400; color: #000000; line-height: 1.75; max-width: 680px; }
  .about-credentials { margin-top: 40px; display: flex; flex-wrap: wrap; gap: 10px; }
  .about-badge { display: inline-flex; align-items: center; gap: 7px; padding: 8px 14px; border-radius: 40px; border: 1px solid rgba(27,79,155,0.2); background: #ffffff; font-size: 12px; font-weight: 500; color: #1B4F9B; }
  .about-section-rule { border: none; border-top: 1px solid rgba(27,79,155,0.15); margin: 0; }
  .about-leadership-section { padding: 80px 0 100px; }
  .about-leadership-layout { display: grid; grid-template-columns: 340px 1fr; gap: 80px; align-items: start; margin-top: 60px; }
  .about-portrait-card { background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(27,79,155,0.10); border: 1px solid rgba(27,79,155,0.15); }
  .about-portrait-bg { background: linear-gradient(135deg, #0F2E5A 0%, #1B4F9B 100%); height: 220px; display: flex; align-items: center; justify-content: center; position: relative; overflow: hidden; }
  .about-portrait-initials { width: 88px; height: 88px; border-radius: 50%; background: rgba(255,255,255,0.12); border: 2px solid rgba(255,255,255,0.25); display: flex; align-items: center; justify-content: center; font-family: 'Georgia', serif; font-size: 32px; color: #ffffff; position: relative; z-index: 1; }
  .about-portrait-info { padding: 28px; }
  .about-portrait-name { font-family: 'Georgia', serif; font-size: 22px; color: #000000; margin-bottom: 4px; }
  .about-portrait-role { font-size: 12px; font-weight: 600; letter-spacing: 0.1em; text-transform: uppercase; color: #1B4F9B; margin-bottom: 20px; }
  .about-portrait-firms { display: flex; flex-direction: column; gap: 8px; }
  .about-firm-tag { font-size: 12px; color: #000000; display: flex; align-items: center; gap: 8px; }
  .about-firm-tag::before { content: ''; display: block; width: 20px; height: 1px; background: #8FA8C8; flex-shrink: 0; }
  .about-expertise-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 36px; }
  .about-expertise-card { padding: 20px; border-radius: 12px; border: 1px solid rgba(27,79,155,0.15); background: #ffffff; }
  .about-expertise-icon { font-size: 22px; margin-bottom: 10px; }
  .about-expertise-title { font-size: 13px; font-weight: 600; color: #000000; margin-bottom: 4px; }
  .about-expertise-desc { font-size: 12px; color: #000000; line-height: 1.55; }
  .about-closing { background: #0F2E5A; padding: 100px 40px; text-align: center; position: relative; overflow: hidden; }
  .about-closing-inner { position: relative; z-index: 1; max-width: 640px; margin: 0 auto; }
  .about-closing blockquote { font-family: 'Georgia', serif; font-size: clamp(24px, 3.5vw, 38px); font-style: italic; color: #ffffff; line-height: 1.3; margin-bottom: 24px; }
  .about-closing-attr { font-size: 12px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: #8FA8C8; }
          ...
          <div className="about-leadership-layout">
            ...
            <div>
              <p className="about-section-body">
                ...
                <br /><br />
                Claude is the public-facing voice of FlightElevate — translating the platform's aviation-rooted vision into business strategy and building the
