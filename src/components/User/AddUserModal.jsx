          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Certificate Level / Ratings
                </label>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Pilot Certificate</p>
                  ...
                  <div>
                    <p className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Flight Instructor Certificate</p>
                    <div className="w-full border border-gray-300 rounded-lg px-4 py-3 bg-white space-y-2">
